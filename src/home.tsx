  ...
  return (
    <Center h="100vh" bgImg="https://wallpapersmug.com/download/1440x900/ba787c/black-dark-cubes-abstract.jpg">
      <Box>
        ...
        <Button as={Link} to="/countdown" variant="outline" colorScheme="red" _hover={{
              backgroundColor: "red.500",
              color: "black",
            }} m={2} w="100%">
          CountDown
        </Button>
        <Button as={Link} to="/tictactoe" variant="outline" colorScheme="yellow" _hover={{
              backgroundColor: "yellow.500",
              color: "black",
            }} m={2} w="100%">
          Tictactoe
        </Button>
        <Button as={Link} to="/wordSramble" variant="outline" colorScheme="green" _hover={{
